...
namespace DA.Migrations
{
    ...
    [Migration("20241003105543_InventoryGroupTableAndRelationsUpdated")]
    partial class InventoryGroupTableAndRelationsUpdated
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DM.DomainModels.ItemGroup", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("DM.DomainModels.Items", b =>
                {
                    b.HasOne("DM.DomainModels.ItemGroup", "ItemGroup")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("DM.DomainModels.Tax", b =>
                {
                    b.HasOne("DM.DomainModels.Items", "Items")
                        .WithOne("Taxes")
                        .HasForeignKey("DM.DomainModels.Tax", "ItemId");
